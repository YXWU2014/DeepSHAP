...
def cluster_summary_plots(clus_attr_lst, rand_attr_lst, clusters, raw_clusters, feat_names):
    ...
    for i in range(len(clusters)):
        ...
        plt.savefig(
            "fig/cluster_gender_{}_age_{}_{}.pdf".format(gender, age_min, age_max))
        plt.show()
        ...
        shap.summary_plot(rand_attr, features=trainx2, feature_names=feat_names,
                          max_display=6, show=False)
        plt.savefig(
            "fig/random_gender_{}_age_{}_{}.pdf".format(gender, age_min, age_max))
        plt.show()
